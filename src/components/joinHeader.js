                        ...
                        <Container>
                            <Row>
                                ...
                                <div className="menu-box d-flex justify-content-end">
                                            ...
                                            <a className="nav-link dropdown-toggle" href ="https://twitter.com/Bscpool1" style={{color: "white"}} target = "_blank">
                                            ...
                                            <li className="nav-item dropdown">
                                                ...
                                                <a className="nav-link dropdown-toggle" href ="http://t.me/bscpool" style={{color: "white"}} target = "_blank">
                                            ...
                                            <li className="nav-item dropdown">
                                                {/* <Link className="nav-link dropdown-toggle"  data-toggle="dropdown"> */}
                                                <a className="nav-link dropdown-toggle" href ="https://github.com/BSCPOOL" style={{color: "white"}} target = "_blank">
