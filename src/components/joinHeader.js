...
class Joinheader extends Component {
    render() {
        return (
                <Styles>
                    {/* Logo Area 2 */}
                    <section style={{background : "#f3ba2f"}} className=" logo-area2">
                        <Container>
                            <Row>
                                <Col md="2">
                                <div className="logo">
                                        <Link to={process.env.PUBLIC_URL + "/"}><img style={{height: "60px"}} src={Logo} alt="" /><span style={{color: "black"}} className="Logo">BSCPOOL</span></Link>
                                    </div>
                                </Col>
                                <Col md="7">
                                <div className="menu-box d-flex justify-content-end">
                                            ...
                                            <a className="nav-link dropdown-toggle" href ="https://twitter.com/Bscpool1" style={{color: "black"}} target = "_blank">
                                            ...
                                            <li className="nav-item dropdown">
                                                ...
                                                <a className="nav-link dropdown-toggle" href ="http://t.me/bscpool" style={{color: "black"}} target = "_blank">
                                            ...
                                            <li className="nav-item dropdown">
                                                {/* <Link className="nav-link dropdown-toggle"  data-toggle="dropdown"> */}
                                                <a className="nav-link dropdown-toggle" href ="https://github.com/BSCPOOL" style={{color: "black"}} target = "_blank">
