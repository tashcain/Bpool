                ...
                <Container>
                    <Row>
                        <Col md="0" sm="12">
                            ...
                            <div className="logo">
                            <Link to={process.env.PUBLIC_URL + "/"}><img style={{height: "40px", fontsize: "1.7rem"}} src={Logo} alt="" /><span className="Logo">BSCPOOL</span></Link>
                        </div>
                                ...
                                <div>
                                        <Link to="/join"><button class="custom-btnlm btn-13l">Launch App</button></Link>
                                        </div>
