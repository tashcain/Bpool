            ...
            <section className="bg-dark sticky-menu">
                <Container>
                    ...
                    <Col md="2">
                        ...
                        {/* <Col md="3">
                            <div className="logo">
                                <Link to={process.env.PUBLIC_URL + "/"}><img  src={process.env.PUBLIC_URL + "/assets/images/Evren-Education-Consultants-logo.png"} alt="" /></Link>
                            </div>
                        </Col> */}
                        <Col md="10">
                            <div className="menu-box d-flex justify-content-end">
                                <ul  className="nav menu-nav">
                                    ...
                                    <li className="nav-item dropdown">
                                        <Link className="nav-link dropdown-toggle" to={process.env.PUBLIC_URL + "/"} data-toggle="dropdown">Benifits <i className="las la-angle-down"></i></Link>
                                        
                                    </li>
                                    <li className="nav-item dropdown">
                                        <Link className="nav-link dropdown-toggle" to={process.env.PUBLIC_URL + "/"} data-toggle="dropdown">Testimonial <i className="las la-angle-down"></i></Link>
                                        
                                    </li>
                                    
                                    <li className="nav-item dropdown">
                                        <Link className="nav-link dropdown-toggle" to={process.env.PUBLIC_URL + "/"} data-toggle="dropdown">Join the Club <i className="las la-angle-down"></i></Link>
